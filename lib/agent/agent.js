...
Agent.prototype = {
    ...
    connect: function () {
        ...
        console.log('connect url:%s', uri);

        var socket = require('socket.io-client')(uri,
            //{ 'force new connection': true, 'try multiple transports': false }
            { forceNew: true, reconnection: true, multiplex: false, transports: ['websocket'] }
        );
        // socket.on('connect', function () {
        //     console.log('connect success...');
        // });
        // socket.on('connect_error', function (err) {
        //     console.log('connect fail:' + err.stack);
        ...
        agent.socket.on('connect_error', function (err) {
        ...
        agent.socket.on('disconnect', function (reason) {
            agent.socket.disconnect();
            agent.log.error("Disconnect..." + reason);
        });
        // Server heartbeat
